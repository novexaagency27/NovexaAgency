/**
 * NOVEXA — Portfolio Page CTA Banner
 * "Let's Create Something Worth Showing." — Premium full-width section.
 */
...
export const PortfolioCTABanner: React.FC = () => {
  const { ref, isInView } = useScrollReveal({ threshold: 0.2 });

  return (
    <section
      id="portfolio-cta-banner"
    ...
    >
      ...
      <div className="container-novexa" style={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          ...
          >
            Ready to elevate your brand identity, build an iconic website, or create cinematic content?
            Connect with us on WhatsApp to discuss your next project.
          </motion.p>
          ...
          >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              id="portfolio-cta-talk-whatsapp"
...
export default PortfolioCTABanner;
