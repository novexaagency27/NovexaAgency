/**
 * NOVEXA — Process Page CTA Banner
 * "Ready to Start Your Creative Journey?" — Premium call to action banner.
 */
...
export const ProcessCTABanner: React.FC = () => {
  const { ref, isInView } = useScrollReveal({ threshold: 0.2 });

  return (
    <section
      id="process-cta-banner"
      aria-label="Start your project process"
      style={{
    ...
    >
      ...
      <div className="container-novexa" style={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          ...
          >
            Start with a discovery conversation. We will walk through your brand goals, outline a tailored workflow,
            and establish a clear project timeline.
          </motion.p>
...
export default ProcessCTABanner;
