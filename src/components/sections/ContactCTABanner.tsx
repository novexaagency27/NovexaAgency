/**
 * NOVEXA — Contact Page CTA Banner
 * "Ready to Build Your Brand?" — Premium call to action banner.
 */
...
export const ContactCTABanner: React.FC = () => {
  ...
  return (
    <section
      ...
      aria-label="Start your project contact"
      style={{
    ...
    >
      ...
      <div className="container-novexa" style={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          ...
          >
            Let's create something remarkable together. Reach out via WhatsApp to discuss your brand vision with NOVEXA.
          </motion.p>
          ...
          >
            <motion.a
              ...
              id="contact-cta-start-project-btn"
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              id="contact-cta-talk-whatsapp-btn"
